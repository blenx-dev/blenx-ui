...
import { Separator, Surface, VStack, Text } from "@blenx-dev/ui";
import { DocsLayout } from "@/components/docs-layout";
import { theme, fontSize, spacing, lineHeight, fontWeight, fonts } from "@blenx-dev/theme/theme.stylex";
...
import { theme, borderRadius, spacing, fontSize } from "@blenx-dev/ui/theme/tokens.stylex";`}</code>
            </Surface>
          </VStack>
        </div>
